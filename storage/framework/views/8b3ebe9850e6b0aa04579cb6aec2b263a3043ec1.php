...
<nav class="navbar navbar-custom  navbar-expand-lg navbar-dark">
  <a class="navbar-brand" href="#">Event RJ</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <?php if(session()->has('user') && (session()->get('usertype')==='customer')): ?>
      <li class="nav-item">
...
</head><?php /**PATH C:\Users\K.RAM JEEVAN\laravel\G-06_EventManagementSystem-master\resources\views/header.blade.php ENDPATH**/ ?>