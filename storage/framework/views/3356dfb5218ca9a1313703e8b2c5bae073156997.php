	...
	<div id="container">
		...
		<?php $__currentLoopData = $venues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		  <div class="col-sm-12 col-md-6 col-lg-4 my-2">
			<div class="card">
			<!--<img src="/images/<?php echo e($venue['venue_image']); ?>" class="card-img-top" alt="..." width="20%" height="300px">-->
			  <div class="card-body">
				<h5 class="card-title"><?php echo e($venue['venue_name']); ?></h5>
				<p class="card-text"><?php echo e($venue['address']); ?></p>
				<p class="card-text" style="float:left;"><b>Booking amount:</b><?php echo e($venue['price']); ?></p>
				<p class="card-text">&nbsp&nbsp<b>Capacity:</b><?php echo e($venue['capacity']); ?></p>
			  </div>
			</div>
		  </div>
...
<div id="main2">
	<div id="sub">
		...
		<div id="sub1">
			<form action="venues?id=<?php echo e($id); ?>" method="post">
				<?php echo csrf_field(); ?>			
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\K.RAM JEEVAN\laravel\G-06_EventManagementSystem-master\resources\views/venues.blade.php ENDPATH**/ ?>